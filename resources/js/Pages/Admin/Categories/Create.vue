    ...
    <div class="py-12">
      <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg p-6">
          <h2 class="text-2xl font-bold mb-6 text-gray-800">Новая категория</h2>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div>
              ...
              <input 
                ...
                placeholder="Например: Аллергия на продукты"
                required 
              />
            ...
            <div>
              ...
              />
              <p class="text-xs text-gray-500 mt-1">Используется в URL, например: /blog/category/allergiya-na-produkty</p>
