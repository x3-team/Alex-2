...
return function (string $namePrefix = 'doctors.'): void {
    ...
    Route::get('/videos', [DoctorVideosController::class, 'index'])->name($namePrefix.'videos');
    Route::get('/videos/{slug}', [DoctorVideosController::class, 'show'])->name($namePrefix.'videos.show');
